sap.ui.define([
          "sns/basis/nav1/controller/BaseController",
          "sap/ui/model/Filter",
          "sap/ui/model/FilterOperator",
          "sap/ui/model/Sorter"
], function(BaseController, Filter, FilterOperator, Sorter) {
          "use strict";
          return BaseController.extend("sns.basis.nav1.controller.employee.overview.EmployeeOverviewContent", {
        	 onInit: function() {
        	 ...
        	 _onRouteMatched: function(oEvent) {
        		 ...
        		 if (this._oRouterArgs.query) {
        			 ...
        			 if (!! this._oRouterArgs.query.showDialog) {
        				 this._oVSD.open();
        				 // the dialog is not closed automatically 
        	 ...
        	 onSearchEmployeesTable: function(oEvent) {
        		 var oRouter = this.getRouter();
        		 // update hash with the search term
